    ...
    <div className="border-2 border-[#96a5ba] rounded-md p-6 bg-white w-[300px]">
      <div className="flex flex-col gap-4">
        <div>
          ...
          <p className="font-lato text-[14px] font-medium leading-6 text-[#2d3e5c]">{endProduct}</p>
        </div>

        <div>
          <p className="font-lato font-semibold leading-6 text-[#2d3e5c]">Capacity</p>
          <p className="font-lato text-[14px] font-medium leading-6 text-[#2d3e5c]">{capacity}</p>
        </div>

        <div>
          <p className="font-lato font-semibold leading-6 text-[#2d3e5c]">Location</p>
          <p className="font-lato text-[14px] font-medium leading-6 text-[#2d3e5c]">{location}</p>
        </div>
      </div>
    </div>
  );
