const StatsBox = ({ contentData, barData }) => {
    return (
        <div className="bg-[#e6eef5] rounded-md border border-[#cad9ed] mt-4 w-full max-w-[361px] ml-auto absolute top-0 right-4 shadow-custom-1">
            <div className="flex justify-center flex-col items-center py-4">
                <div className="text-[28px] font-bold text-[#ae2d2d]">€ {barData?.[2] || contentData?.clientMachineSparePart?.totalLossCost?.value}</div>
            ...
            <div className="border-t border-[#cad9ed]">
                <div className="flex justify-between relative px-4">
                    <div className="flex flex-col py-4 w-1/2">
                        <span className="text-[#2d3e5c] font-bold text-xl text-center">€ {barData?.[1] ||contentData?.clientMachineSparePart?.totalFiberLossCost?.value}</span>
                    ...
                    <div className="border-[#cad9ed] flex flex-col py-4 w-1/2">
                        <span className="text-[#2d3e5c] font-bold text-xl text-center">€ {barData?.[0] ||contentData?.clientMachineSparePart?.totalPowerLossCost?.value}</span>
